...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    return run.Config(LlamaModel, config=run.Config(Llama31Config8B))
...
def pretrain_recipe(
    ...
    Args:
        ...
        data_path (str): Path to the training folder.
    ...
    recipe = run.Partial(
        ...
        log=default_log(
            dir=dir,
            name=name,
            wandb_logger=wandb_logger(project="dw_scaling", name=name),
        ),
